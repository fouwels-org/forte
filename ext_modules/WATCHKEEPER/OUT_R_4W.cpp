...
#include "OUT_R_4W_gen.cpp"
#endif

DEFINE_FIRMWARE_FB(FORTE_OUT_R_4W, g_nStringIdOUT_R_4W)

const CStringDictionary::TStringId FORTE_OUT_R_4W::scm_anDataInputNames[] = {g_nStringIdEN, g_nStringIdPREFIX, g_nStringIdID1, g_nStringIdO1, g_nStringIdID2, g_nStringIdO2, g_nStringIdID3, g_nStringIdO3, g_nStringIdID4, g_nStringIdO4};

const CStringDictionary::TStringId FORTE_OUT_R_4W::scm_anDataInputTypeIds[] = {g_nStringIdBOOL, g_nStringIdWSTRING, g_nStringIdWSTRING, g_nStringIdREAL, g_nStringIdWSTRING, g_nStringIdREAL, g_nStringIdWSTRING, g_nStringIdREAL, g_nStringIdWSTRING, g_nStringIdREAL};

const CStringDictionary::TStringId FORTE_OUT_R_4W::scm_anDataOutputNames[] = {g_nStringIdST};

const CStringDictionary::TStringId FORTE_OUT_R_4W::scm_anDataOutputTypeIds[] = {g_nStringIdBOOL};

const TForteInt16 FORTE_OUT_R_4W::scm_anEIWithIndexes[] = {0, 2};
const TDataIOID FORTE_OUT_R_4W::scm_anEIWith[] = {0, 255, 0, 2, 4, 6, 8, 3, 5, 7, 9, 255};
const CStringDictionary::TStringId FORTE_OUT_R_4W::scm_anEventInputNames[] = {g_nStringIdINIT, g_nStringIdREQ};

const TDataIOID FORTE_OUT_R_4W::scm_anEOWith[] = {0, 255, 0, 255};
const TForteInt16 FORTE_OUT_R_4W::scm_anEOWithIndexes[] = {0, 2, -1};
const CStringDictionary::TStringId FORTE_OUT_R_4W::scm_anEventOutputNames[] = {g_nStringIdINITO, g_nStringIdCNF};

const SFBInterfaceSpec FORTE_OUT_R_4W::scm_stFBInterfaceSpec = {
...
const SCFB_FBInstanceData FORTE_OUT_R_4W::scm_astInternalFBs[] = {
  ...
  {g_nStringIdint2, g_nStringIdFilterReal},
  {g_nStringIdint3, g_nStringIdFilterReal},
  {g_nStringIdint4, g_nStringIdFilterReal},
  {g_nStringIdint1, g_nStringIdFilterReal},
...
const SCFB_FBParameter FORTE_OUT_R_4W::scm_astParamters[] = {
...
const SCFB_FBConnectionData FORTE_OUT_R_4W::scm_astEventConnections[] = {
  ...
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdENABLE, g_nStringIdEO), 0, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint2, g_nStringIdREQ), 6},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint2, g_nStringIdCNF), 6, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_1_0_1, g_nStringIdREQ), 3},
  ...
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint4, g_nStringIdCNF), 8, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_1_0_1_1_1, g_nStringIdREQ), 5},
  ...
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdENABLE_1, g_nStringIdEO), 1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdVar_Path_OPC_W, g_nStringIdREQ), 15},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdVar_Path_OPC_W, g_nStringIdCNF), 15, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_1_0, g_nStringIdINIT), 2},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_1_0, g_nStringIdINITO), 2, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdVar_Path_OPC_W_1, g_nStringIdREQ), 16},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdVar_Path_OPC_W_1, g_nStringIdCNF), 16, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_1_0_1, g_nStringIdINIT), 3},
...
const SCFB_FBFannedOutConnectionData FORTE_OUT_R_4W::scm_astFannedOutEventConnections[] = {
  {3, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint3, g_nStringIdREQ), 7},
  {3, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint4, g_nStringIdREQ), 8},
  {3, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint1, g_nStringIdREQ), 9},
  {3, GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdCNF), -1},
};

const SCFB_FBConnectionData FORTE_OUT_R_4W::scm_astDataConnections[] = {
  ...
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint2, g_nStringIdOUT), 6, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_1_0_1, g_nStringIdSD_1), 3},
  ...
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint4, g_nStringIdOUT), 8, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_1_0_1_1_1, g_nStringIdSD_1), 5},
  ...
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdO2), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint2, g_nStringIdIN), 6},
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdO3), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint3, g_nStringIdIN), 7},
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdO4), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint4, g_nStringIdIN), 8},
  ...
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdID1), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdVar_Path_OPC_W, g_nStringIdNodeId_1), 15},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdVar_Path_OPC_W, g_nStringIdENABLED), 15, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_1_0, g_nStringIdQI), 2},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdVar_Path_OPC_W, g_nStringIdOUT), 15, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_1_0, g_nStringIdID), 2},
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdID2), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdVar_Path_OPC_W_1, g_nStringIdNodeId_1), 16},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdVar_Path_OPC_W_1, g_nStringIdENABLED), 16, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_1_0_1, g_nStringIdQI), 3},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdVar_Path_OPC_W_1, g_nStringIdOUT), 16, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_1_0_1, g_nStringIdID), 3},
  ...
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdPREFIX), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdVar_Path_OPC_W, g_nStringIdPrefix), 15},
};

const SCFB_FBFannedOutConnectionData FORTE_OUT_R_4W::scm_astFannedOutDataConnections[] = {
  {0, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdENABLE_1, g_nStringIdPERMIT), 1},
  {30, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdVar_Path_OPC_W_1, g_nStringIdPrefix), 16},
...
const SCFB_FBNData FORTE_OUT_R_4W::scm_stFBNData = {
