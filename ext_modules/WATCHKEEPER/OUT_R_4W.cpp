...
const CStringDictionary::TStringId FORTE_OUT_R_4W::scm_anDataInputNames[] = {g_nStringIdEN, g_nStringIdID1, g_nStringIdO1, g_nStringIdID2, g_nStringIdO2, g_nStringIdID3, g_nStringIdO3, g_nStringIdID4, g_nStringIdO4};

const CStringDictionary::TStringId FORTE_OUT_R_4W::scm_anDataInputTypeIds[] = {g_nStringIdBOOL, g_nStringIdWSTRING, g_nStringIdREAL, g_nStringIdWSTRING, g_nStringIdREAL, g_nStringIdWSTRING, g_nStringIdREAL, g_nStringIdWSTRING, g_nStringIdREAL};
...
const TDataIOID FORTE_OUT_R_4W::scm_anEIWith[] = {0, 255, 0, 1, 3, 5, 7, 2, 4, 6, 8, 255};
...
const SCFB_FBConnectionData FORTE_OUT_R_4W::scm_astEventConnections[] = {
  ...
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdENABLE, g_nStringIdEO), 0, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint2, g_nStringIdREQ), 10},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint2, g_nStringIdCNF), 10, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_1_0_1, g_nStringIdREQ), 3},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint3, g_nStringIdCNF), 11, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_1_0_1_1, g_nStringIdREQ), 4},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint4, g_nStringIdCNF), 12, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_1_0_1_1_1, g_nStringIdREQ), 5},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint1, g_nStringIdCNF), 13, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_1_0, g_nStringIdREQ), 2},
};

const SCFB_FBFannedOutConnectionData FORTE_OUT_R_4W::scm_astFannedOutEventConnections[] = {
  {12, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint3, g_nStringIdREQ), 11},
  {12, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint4, g_nStringIdREQ), 12},
  {12, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint1, g_nStringIdREQ), 13},
};
...
const SCFB_FBConnectionData FORTE_OUT_R_4W::scm_astDataConnections[] = {
  ...
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint2, g_nStringIdOUT), 10, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_1_0_1, g_nStringIdSD_1), 3},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint3, g_nStringIdOUT), 11, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_1_0_1_1, g_nStringIdSD_1), 4},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint4, g_nStringIdOUT), 12, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_1_0_1_1_1, g_nStringIdSD_1), 5},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint1, g_nStringIdOUT), 13, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_1_0, g_nStringIdSD_1), 2},
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdO1), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint1, g_nStringIdIN), 13},
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdO2), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint2, g_nStringIdIN), 10},
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdO3), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint3, g_nStringIdIN), 11},
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdO4), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdint4, g_nStringIdIN), 12},
};
