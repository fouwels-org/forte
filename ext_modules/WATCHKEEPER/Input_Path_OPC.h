...
#ifndef _INPUT_PATH_OPC_H_
#define _INPUT_PATH_OPC_H_

#include <simplefb.h>
#include <forte_wstring.h>

class FORTE_Input_Path_OPC: public CSimpleFB{
  DECLARE_FIRMWARE_FB(FORTE_Input_Path_OPC)
...
public:
  FORTE_Input_Path_OPC(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) : 
       CSimpleFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId,
              0, m_anFBConnData, m_anFBVarsData){
  };

  virtual ~FORTE_Input_Path_OPC(){};
