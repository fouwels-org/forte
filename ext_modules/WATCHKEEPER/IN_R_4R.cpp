...
const CStringDictionary::TStringId FORTE_IN_R_4R::scm_anDataInputNames[] = {g_nStringIdEN, g_nStringIdID1, g_nStringIdID2, g_nStringIdID3, g_nStringIdID4};

const CStringDictionary::TStringId FORTE_IN_R_4R::scm_anDataInputTypeIds[] = {g_nStringIdBOOL, g_nStringIdWSTRING, g_nStringIdWSTRING, g_nStringIdWSTRING, g_nStringIdWSTRING};
...
const TForteInt16 FORTE_IN_R_4R::scm_anEIWithIndexes[] = {0, 2};
const TDataIOID FORTE_IN_R_4R::scm_anEIWith[] = {0, 255, 0, 1, 2, 3, 4, 255};
...
const SCFB_FBFannedOutConnectionData FORTE_IN_R_4R::scm_astFannedOutEventConnections[] = {
  {12, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdR1, g_nStringIdREQ), 10},
  {13, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdR2, g_nStringIdREQ), 11},
  {14, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdR3, g_nStringIdREQ), 12},
  {15, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdR4, g_nStringIdREQ), 13},
};
...
const SCFB_FBConnectionData FORTE_IN_R_4R::scm_astDataConnections[] = {
  ...
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_1, g_nStringIdRD_1), 2, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdR1, g_nStringIdIN), 10},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_2, g_nStringIdRD_1), 3, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdR2, g_nStringIdIN), 11},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_3, g_nStringIdRD_1), 4, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdR3, g_nStringIdIN), 12},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdCLIENT_4, g_nStringIdRD_1), 5, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdR4, g_nStringIdIN), 13},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdR1, g_nStringIdOUT), 10, GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdQ1), -1},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdR2, g_nStringIdOUT), 11, GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdQ2), -1},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdR3, g_nStringIdOUT), 12, GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdQ3), -1},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdR4, g_nStringIdOUT), 13, GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdQ4), -1},
};
